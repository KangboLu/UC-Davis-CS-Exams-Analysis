...
# Combine 132, 145, and 158 data and modify course name column data
...
#student_quiz[["major"]] <- factor(student_quiz[["major"]], levels = c(1,2), labels = c("CS", "CSE"))
levels(student_quiz[["major"]])[levels(student_quiz[["major"]]) == "LCSI"] <- "CS"
levels(student_quiz[["major"]])[levels(student_quiz[["major"]]) == "ECSE"] <- "CSE"
...
#================================================================================
# ECS132_sample_mean − ECS145_sample_mean ± R
...
cat("\nApprox. 95% CI for the difference in ECS132 and ECS145 Population Mean =", 
    ECS132_sample_mean - ECS145_sample_mean - R,"to", ECS132_sample_mean - ECS145_sample_mean + R,"\n")
...
# creating dummy variables for 'major' and 'course name'
...
is_ECS158 <- as.integer(coursecodes==3)
